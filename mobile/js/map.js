...
function createMap(){
	...
	var point = new BMap.Point(116.163038,39.737813);//定义一个中心点坐标
...
//标注点数组
var markerArr = [{title:"儒艺教育 北京校区",content:"北京市房山区良乡东路华学书院",point:"116.160622|39.738049",isOpen:0,icon:{w:30,h:40,l:0,t:0,x:0,lb:20}}
	 ];
//创建marker
function addMarker(){
